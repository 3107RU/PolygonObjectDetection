...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../runs/train/exp6/weights/polygon_best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='data/images/UCAS-AOD', help='file/dir/URL/glob, 0 for webcam')
